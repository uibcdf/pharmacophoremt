...
- **topomt**: Used in structure-based workflows to identify cavities, pockets, and tunnels. These analytical results inform the placement of "Included" and "Excluded" volume interaction sites.
...
- `msm.get(pharmacophore, n_interaction sites=True)`
