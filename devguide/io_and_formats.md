...
- **Reader**: Converts external data (JSON, XML, etc.) into a list of internal `InteractionSite` objects (Feature + Shape).
- **Writer**: Maps internal `InteractionSite` objects back to the external software's specific feature definitions and coordinate systems.
