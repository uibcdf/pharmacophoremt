...
project = 'PharmacophoreMT'
copyright = ''

# The short X.Y version
version = pharmacophoremt.__version__.split('+')[0]
# The full version, including alpha/beta/rc tags
release = pharmacophoremt.__version__.split('+')[0]
...
html_theme_options = {
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/uibcdf/pharmacophoremt",
...
htmlhelp_basename = 'pharmacophoremtdoc'
