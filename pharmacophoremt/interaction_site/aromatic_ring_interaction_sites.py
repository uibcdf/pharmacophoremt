...
from .shape import Point, Shapelet, Sphere, SphereAndVector
...
class AromaticRingPoint(InteractionSite):
    def __init__(self, position, skip_digestion=False):
        ...
        super().__init__(
            Point(position), "aromatic ring", skip_digestion=skip_digestion
        )
...
class AromaticRingSphere(InteractionSite):
    def __init__(self, center, radius, skip_digestion=False):
        ...
        super().__init__(
            Sphere(center, radius), "aromatic ring", skip_digestion=skip_digestion
        )
