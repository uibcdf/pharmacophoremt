...
from .shape import GaussianKernel, Point, Shapelet, Sphere
...
class ExcludedVolumePoint(InteractionSite):
    def __init__(self, position, skip_digestion=False):
        ...
        super().__init__(
            Point(position), "excluded volume", skip_digestion=skip_digestion
        )
...
class ExcludedVolumeSphere(InteractionSite):
    def __init__(self, center, radius, skip_digestion=False):
        ...
        super().__init__(
            Sphere(center, radius), "excluded volume", skip_digestion=skip_digestion
        )
